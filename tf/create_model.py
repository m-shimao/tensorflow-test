...
####　main　####
##############
train_horse,train_label = horse_data.get_horse_and_label()
...
with tf.Graph().as_default():
	...
	summary_writer = tf.summary.FileWriter(LEARNING_LOG_DIR+'/test_log', sess.graph)
	...
	# Test trained model
	test_horse,test_label = horse_data.get_test_horse_and_label()
